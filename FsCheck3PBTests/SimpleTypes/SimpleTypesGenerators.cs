...
public static class SimpleTypesGenerators
{
    ...
    // In order to use generator in the property-based tests, we need to create an Arbitrary instance
    ...
    // When there are two generators generating the same type, the one being higher inside a class is used.
